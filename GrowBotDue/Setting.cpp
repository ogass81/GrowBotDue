...
void Setting::saveActiveConfig()
{
	Setting::saveSettings("_CURRENTCONFIG.JSON");
}

void Setting::saveBackupConfig()
{
	Setting::copyFile("_CURRENTCONFIG.JSON", "BACKUPCONFIG.JSON");
}

void Setting::saveDefaultConfig()
{
	Setting::saveSettings("DEFAULTCONFIG.JSON");
}

void Setting::loadActiveConfig()
{
	Setting::loadSettings("_CURRENTCONFIG.JSON");
}

void Setting::loadBackupConfig()
{
	Setting::loadSettings("BACKUPCONFIG.JSON");
}

void Setting::loadDefaultConfig()
{
